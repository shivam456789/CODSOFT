...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='black', font='times 15 bold')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', fg='darkblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', fg='darkblue')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', fg='darkblue')
